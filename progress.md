...
| 售罄新盘保留 | 修复更新脚本把仍在 URA 供应管道中的售罄新盘排除的问题；新增「售罄」状态并补回 533 户 Lentor Mansion，含精确坐标、产权、用途、开发商合资归属、学校、地铁与官方项目资料 |
| Thomson Reserve 开盘日期 | 地图更新为预计 2026-10-17 正式开盘、展销厅预计 10-03 开放；公开营销资料仍标 estimated，开发商官方项目页暂未列日期，因此保留「预计」口径 |
| 有地住宅筛选 | 为全部项目加入住宅形态字段，并新增「有地/分层有地」显示开关；当前核验 5 个 Landed 项目，以及含 terrace house 的 Lentor Gardens Residences。关闭开关后地图图钉和项目列表同步隐藏，日更脚本会持续保留并重算分类 |
| The Serra Residences | 补入 URA Pipeline 因 133 户规模门槛暂未覆盖的新盘；按开发商官网核验 D11、永久产权、133 户、Far East Organization、预计 2030 Q4 TOP，并用 OneMap 门牌 309837 校准坐标、最近 MRT 与 1km 小学。更新脚本会保留官网链接，未来 URA 接管后不丢失 |
